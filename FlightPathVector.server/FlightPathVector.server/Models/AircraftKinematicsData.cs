...
namespace SimulatorDataReader
{
  class AircraftKinematicsData
  {
    ...
    public void ConvertAircraftKinematicsData(Byte[] data)
    {
    ...
    public void checkSimulationRunning(Byte[] data)
    {
      byte running = data[4];
      ...
      AsynchronousSocketListener.Send(toSend);
    }
