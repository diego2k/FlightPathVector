        ...
        else
        {
            ...
            try
            {
                if (DataListener.socket != null)
                {
                    ...
                    UserData userData = new UserData(DataListener.criteria.Usercode,
                        DataListener.criteria.CorrectAnswers, user_answers, time, DataListener.criteria.Points, quizScore);
                    DataListener.LAST_USERDATA = userData;
