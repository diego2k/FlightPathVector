...
public class DataListener : MonoBehaviour
{
  ...
  //home
  //private static string ip = "192.168.8.109";
  //work
  ...
  public async void StartConnection()
  {
    ...
    if (socket == null)
    {
      await Task.Run(() => StartAirCraftSocket());
    }
  ...
  public async void StartAirCraftSocket()
  {
      ...
      try
      {
        using (DataReader reader = new DataReader(socket.InputStream))
        {
          ...
          while (true)
          {
            ...
            cleanedString = reader.ReadString(bytesRead);
